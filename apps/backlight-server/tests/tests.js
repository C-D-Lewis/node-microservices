...
describe('API', () => {
  describe('Conduit topic: status', () => {
    it('should return 200 / OK', async () => {
      const result = await testing.sendConduitPacket({ to: 'BacklightServer', topic: 'status' });
  ...
  describe('Conduit topic: demo', () => {
    it('should return 200 / OK', async () => {
      const response = await testing.sendConduitPacket({ to: 'BacklightServer', topic: 'demo' });
  ...
  describe('Conduit topic: off', () => {
    it('should return 200 / OK', async () => {
      const response = await testing.sendConduitPacket({ to: 'BacklightServer', topic: 'off' });
  ...
  describe('Conduit topic: spotify', () => {
    it('should return 200 / [r,g,b]', async () => {
      const response = await testing.sendConduitPacket({ to: 'BacklightServer', topic: 'spotify' });
