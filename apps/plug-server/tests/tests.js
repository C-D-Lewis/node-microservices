...
describe('API', () => {
  describe('Conduit topic: status', () => {
    it('should return 200 / OK', async () => {
      const response = await testBed.sendConduitPacket({ to: 'PlugServer', topic: 'status' });
  ...
  describe('Conduit topic: rediscover', () => {
    it('should return 202 / Rediscovery started', async () => {
      const response = await testBed.sendConduitPacket({ to: 'PlugServer', topic: 'rediscover' });
  ...
  describe('Conduit topic: getPlugs', () => {
    it('should return 200 / List of plugs', async () => {
      const response = await testBed.sendConduitPacket({ to: 'PlugServer', topic: 'getPlugs' });
  ...
  describe('Conduit topic: setPlugState', () => {
    it('should return 202 / Accepted', async () => {
      let plugs = await testBed.sendConduitPacket({ to: 'PlugServer', topic: 'getPlugs' });
