...
const { log, csv } = require('../node-common')(['log', 'csv']);

/**
 * ****************** UPDATE DATE! ******************
 */
const OUTPUT_FILE = './JingleJam2025.csv';

const CSV_HEADINGS = ['timestamp', 'value'];
...
module.exports = async () => {
  try {
    const res = await fetch('https://api.tiltify.com/', {
      ...
      body: '{"operationName":"get_cause_and_fe_by_slug","variables":{"causeSlug":"jingle-jam","feSlug":"jingle-jam-2025"},"query":"query get_cause_and_fe_by_slug($feSlug: String!, $causeSlug: String!) {\\n  cause(slug: $causeSlug) {\\n    id\\n    causeFactPublicId\\n    name\\n    slug\\n    trackers\\n    avatar {\\n      alt\\n      height\\n      width\\n      src\\n      __typename\\n    }\\n    social {\\n      discord\\n      facebook\\n      instagram\\n      snapchat\\n      tiktok\\n      twitter\\n      website\\n      youtube\\n      __typename\\n    }\\n    paymentMethods {\\n      type\\n      currency\\n      __typename\\n    }\\n    paymentOptions {\\n      currency\\n      monthlyGiving\\n      __typename\\n    }\\n    __typename\\n  }\\n  fundraisingEvent(slug: $feSlug, causeSlug: $causeSlug) {\\n    publicId\\n    legacyFundraisingEventId\\n    name\\n    slug\\n    trackers\\n    description\\n    supportable\\n    sponsorList {\\n      image {\\n        alt\\n        height\\n        src\\n        width\\n        __typename\\n      }\\n      __typename\\n    }\\n    image {\\n      src\\n      __typename\\n    }\\n    video\\n    avatar {\\n      src\\n      __typename\\n    }\\n    amountRaised {\\n      currency\\n      value\\n      __typename\\n    }\\n    totalAmountRaised {\\n      currency\\n      value\\n      __typename\\n    }\\n    goal {\\n      currency\\n      value\\n      __typename\\n    }\\n    visibility {\\n      raised\\n      goal\\n      donate\\n      toolkit {\\n        url\\n        __typename\\n      }\\n      teamLeaderboard {\\n        visible\\n        __typename\\n      }\\n      userLeaderboard {\\n        visible\\n        __typename\\n      }\\n      __typename\\n    }\\n    publishedCampaignsCount\\n    publishedCampaigns(limit: 50) {\\n      edges {\\n        cursor\\n        node {\\n          ... on Campaign {\\n            publicId\\n            name\\n            slug\\n            live\\n            cause {\\n              name\\n              avatar {\\n                src\\n                __typename\\n              }\\n              __typename\\n            }\\n            user {\\n              id\\n              username\\n              slug\\n              avatar {\\n                src\\n                alt\\n                __typename\\n              }\\n              __typename\\n            }\\n            avatar {\\n              src\\n              alt\\n              __typename\\n            }\\n            totalAmountRaised {\\n              value\\n              currency\\n              __typename\\n            }\\n            goal {\\n              value\\n              currency\\n              __typename\\n            }\\n            cardImage {\\n              src\\n              alt\\n              __typename\\n            }\\n            __typename\\n          }\\n          ... on TeamEvent {\\n            publicId\\n            name\\n            slug\\n            currentSlug\\n            live\\n            cause {\\n              name\\n              avatar {\\n                src\\n                __typename\\n              }\\n              __typename\\n            }\\n            team {\\n              id\\n              name\\n              slug\\n              avatar {\\n                src\\n                alt\\n                __typename\\n              }\\n              __typename\\n            }\\n            avatar {\\n              src\\n              alt\\n              __typename\\n            }\\n            totalAmountRaised {\\n              value\\n              currency\\n              __typename\\n            }\\n            goal {\\n              value\\n              currency\\n              __typename\\n            }\\n            cardImage {\\n              src\\n              alt\\n              __typename\\n            }\\n            __typename\\n          }\\n          __typename\\n        }\\n        __typename\\n      }\\n      __typename\\n    }\\n    social {\\n      discord\\n      facebook\\n      instagram\\n      snapchat\\n      tiktok\\n      twitter\\n      website\\n      youtube\\n      __typename\\n    }\\n    paymentOptions {\\n      currency\\n      monthlyGiving\\n      __typename\\n    }\\n    incentives {\\n      id\\n      title\\n      description\\n      fairMarketValue {\\n        value\\n        currency\\n        __typename\\n      }\\n      amount {\\n        value\\n        currency\\n        __typename\\n      }\\n      image {\\n        src\\n        alt\\n        __typename\\n      }\\n      __typename\\n    }\\n    __typename\\n  }\\n}"}',
      method: 'POST',
      mode: 'cors',
    });
    ...
    // Write CSV file
    await csv.appendRow(OUTPUT_FILE, CSV_HEADINGS, [now, value]);
